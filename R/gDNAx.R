...
#'
#' \itemize{
#' \item \code{\link{identifyStrandMode}} - identify \code{strandMode} (strandedness) in RNA-seq data samples based on the proportion of reads aligning to the same or opposite strand as transcripts in the annotations
